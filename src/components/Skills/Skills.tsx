...
const Skills = () => {
  ...
  const skillSet = [
    ...
    },
    {
      ...
      name: 'Laravel',
      links: [{ name: 'Unidiy', url: 'https://unidiy-image-editor.weivee.com/' }],
    },
    {
      id: 3,
    ...
    },
    {
      ...
      name: 'Figma',
      links: [{ name: 'Figma', url: 'https://unidiy-image-editor.weivee.com/' }],
    },
    {
      id: 8,
        ...
        <div className='icon_bg'>
          <div className='icons'>
            {skillSet.map((skill, index = 1) => {
              return (
                <div
                  className={skill.id === active ? 'skill_box active' : 'skill_box'}
